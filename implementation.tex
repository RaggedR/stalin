...
\midrule
mechanise, arm late & 0 & 18 & \textbf{18} & won \\
build nothing & 0 & 60 & \textbf{60} & lost \\
strip the villages & 53 & 29 & \textbf{82} & lost \\
\bottomrule
\end{tabular}
\end{center}

\noindent Maximum extraction loses the war holding the largest stockpile,
because the famine destroyed the manpower the steel was meant to protect. The
first balance pass had this backwards --- brutality scored \emph{better} --- and
no amount of reading the code would have shown it. Only playing it did.
